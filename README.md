...
> 只让当前窗口是清晰的，其余一切实时模糊 —— 你的屏幕，只为正在看的那个窗口而亮。
...
1. 从 [官网下载页](https://focalveil.app/download) 下载 `.dmg`（或 `.zip`）。
2. 把「凝焦」拖进「应用程序」。
...
详细的隐私说明见 [隐私政策](privacy.html)。

## 价格

$6.99，含 7 天免费试用。定价细节见 [定价页](pricing.html)。
