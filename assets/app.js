...
(function () {
  ...
  var I18N = {
    zh: {
      ...
      "faq6.q": "以后怎么更新？",
      "faq6.a": "自动更新已随 v0.2.0 上线（基于 Sparkle 2）：升级到 v0.2.0 后，菜单栏点「检查更新…」即可自动完成，安装包均经过 Developer ID 签名与 Apple 公证。当前 0.1.x 版本请先手动「检查更新…」升级到 v0.2.0；更早的版本可在官网下载区重新获取安装包。",
    ...
    en: {
      ...
      "faq6.a": "Automatic updates are live from v0.2.0 (built on Sparkle 2): once you're on v0.2.0, just click “Check for Updates…” in the menu bar and it updates itself; every package is Developer ID–signed and Apple-notarized. Current 0.1.x versions should first use “Check for Updates…” manually to reach v0.2.0; even older builds can be re-downloaded from the official site's download area.",
