...
(function () {
  ...
  var I18N = {
    zh: {
      ...
      "download.lede": "当前版本 <strong>v0.1.0</strong>。需要 macOS 14 及以上，Apple Silicon 与 Intel 通用包。",
    ...
    en: {
      ...
      "download.lede": "Current version <strong>v0.1.0</strong>. Requires macOS 14 or later, universal build for Apple Silicon and Intel.",
