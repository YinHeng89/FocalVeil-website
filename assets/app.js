...
(function () {
  ...
  var I18N = {
    zh: {
      ...
      "faq6.q": "以后怎么更新？",
      "faq6.a": "自动更新将随 v0.2.0 上线（基于 Sparkle 2）：升级到 v0.2.0 后，菜单栏点「检查更新…」即可自动完成，安装包均经过 Developer ID 签名与 Apple 公证。当前 0.1.x 版本请先手动「检查更新…」升级到 v0.2.0；更早的版本可在官网下载区重新获取安装包。",
