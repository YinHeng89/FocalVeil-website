...
(function () {
  ...
  var I18N = {
    zh: {
      ...
      "download.lede": "当前版本 <strong>v0.1.44</strong>。需要 macOS 14 及以上，Apple Silicon 与 Intel 通用包。",
      ...
      "meta.perm": "权限",
      "meta.price": "价格",
      "meta.version.val": "0.1.44",
      "meta.req.val": "macOS 14+",
      "meta.arch.val": "通用（arm64 / x86_64）",
      "meta.perm.val": "屏幕录制（可选）",
      "meta.price.val": "基础版 免费 · PRO $14.99",
      "download.updateNote": "自动更新随 v0.2.0 上线，之后菜单栏「检查更新…」即可升级。",

      "title.pricing": "定价 — 凝焦 FocalVeil",
      "meta.pricing": "FocalVeil 定价：基础版 $6.99、PRO 版 $14.99，均为当前大版本一次性买断，无订阅、无广告。",
      "pricing.title": "基础版免费，<span class=\"accent\">PRO 一次买断永久使用</span>",
      "pricing.lede": "基础版完全免费，下载即用，已含核心模糊功能；PRO 版一次性买断，额外解锁全部高级功能。无订阅、无广告、无套路。",
      "pricing.features": "功能介绍",
      "plan.basic": "基础版",
      "plan.pro": "PRO",
      "plan.pro.name": "PRO 版",
      "plan.pro.buy": "购买 PRO 版",
      "plan.basic.price": "免费",
      "pricing.activate": "如何激活",
      "pricing.basicSub": "核心功能 · 永久免费",
      "pricing.proSub": "全部高级功能 · 当前大版本永久",
      "pricing.basicNote": "免费下载，无需购买",
      "pricing.proNote": "解锁全部高级功能",
    ...
    en: {
      ...
      "download.lede": "Current version <strong>v0.1.44</strong>. Requires macOS 14 or later, universal build for Apple Silicon and Intel.",
      ...
      "meta.price.val": "Basic Free · PRO $14.99",
      ...
      "meta.pricing": "FocalVeil pricing: Basic $6.99, PRO $14.99 — both one-time purchases for the current major version. No subscription, no ads.",
      "pricing.title": "Basic is free, <span class=\"accent\">PRO is a one-time purchase</span>",
      "pricing.lede": "Basic is completely free — download and use it right away, with the core blur features included. PRO is a one-time purchase that unlocks every advanced feature. No subscription, no ads, no tricks.",
      "pricing.features": "Features",
      "plan.basic": "Basic",
      "plan.pro": "PRO",
      "plan.pro.name": "PRO",
      "plan.pro.buy": "Buy PRO",
      "plan.basic.price": "Free",
      "pricing.activate": "How to activate",
      "pricing.basicSub": "Core features · free forever",
      "pricing.proSub": "All advanced features · permanent for current major version",
      "pricing.basicNote": "Free to download, no purchase needed",
      "pricing.proNote": "Unlocks every advanced feature",
